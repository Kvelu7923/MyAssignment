...
public class KnowledgeArticles {
	...
	public void login() {
		...
		driver.findElement(By.xpath("//input[@id='kb_knowledge.short_description']")).sendKeys("Knowledge Article");
		driver.findElement(By.xpath("(//input[@class='form-control element_reference_input'])[2]")).sendKeys("java");
		driver.findElement(By.xpath("//input[@name='kb_knowledge.short_description']")).sendKeys("My knowledge");
